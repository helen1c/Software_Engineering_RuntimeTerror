...
export const MessageResult = (prop : Props) => {
    ...
    return (
        <div className="result-box">
            ...
            <span className="result-column"><p>GREŠKA NASTALA:</p>{prop.result.error}</span>
            <text className="result-column"><p>SADRŽAJ:</p>{prop.result.content}</text>
            <span className="result-column">
                <button onClick={update}>RIJEŠENO</button>
            </span>
        </div>
    );
}