      ...
      {!sessionStorage.getItem("key") ? (
        ...
        <div>
                ...
                <div>
                  {!error ? (
                    user.friend ? (
                      ...
                      <button className="button-profile-fr" disabled={true}>
                        Zahtjev poslan &#10004;
                      </button>
                    )
                  ) : (
                    <span className="errorText">
                      ...
                      <button
                        className="button-profile-fr"
                        onClick={handleAddUserAsFriend}
                      >
                        <span className="button-label-fr">
                          {" "}
                          Dodaj prijatelja{" "}
                        </span>
                        <img
          ...
          >
            ...
            <DialogActions>
              <Button
                onClick={() => setOpenRemoveFriendModal(false)}
                color="primary"
              >
                NE
              </Button>
              <Button
                onClick={handleRemoveUserAsFriend}
                color="primary"
                autoFocus
              >
                DA
