...
%Tablice
			...
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
				...
				\hline \multicolumn{3}{|c|}{\textbf{residence\_place - ime tablice}}	 \\[3pt] \hline
				\endhead
	...
	\end{longtabu}
			...
			\begin{longtabu} to \textwidth {|X[6, l]|X[6, l]|X[20, l]|}
				...
				\hline \multicolumn{3}{|c|}{\textbf{path - (Planinarska staza)}}	 \\[3pt] \hline
				\endhead
		...
		\end{longtabu}
			...
			\textbf{mountain\_lodge\_utility} Vezna tablica koja modelira Many-to-Many vezu između planinarskih domova i infrastrukturnih značajki koje ti domovi posjeduju.
