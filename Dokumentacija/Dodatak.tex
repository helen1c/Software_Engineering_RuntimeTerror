...
\end{packed_item}
		...
		\section*{Tablica aktivnosti}
			...
			\begin{longtabu} to \textwidth {|X[7, l]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|X[1, c]|}
				...
				Upravljanje projektom 		& 25 & 5 &  &  &  &  & \\ \hline
		...
		\begin{figure}[H]
			\includegraphics[width=175mm,height=150mm]{slike/aktivnost_1.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
			\caption{Dijagram pregleda promjena 1.dio}
			\label{fig:dijagrami_pregleda_promjena}
		\end{figure}
	\begin{figure}[H]
		\includegraphics[width=170mm,height=160mm]{slike/aktivnost_2.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
		\centering
