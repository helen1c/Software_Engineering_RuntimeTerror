	...
	\end{packed_item}	
		...
		\end{figure}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\begin{figure}[H]
					\includegraphics[scale=0.52]{dijagrami/seq-UC9.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
					\caption{Sekvencijski dijagram za UC9}
					\label{fig:sekvencijski dijagrami}
				\end{figure}
				
				\subsubsection{Obrasci uporabe UC10-UC11-UC11.1}
				...
				\begin{figure}[H]
					\includegraphics[scale=0.5]{dijagrami/seq-UC10 - UC11 - UC11.1.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
					\centering
