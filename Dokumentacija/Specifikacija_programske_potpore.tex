\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
		...
		\begin{packed_item}
			...
			\item[] \begin{packed_enum}
				...
				\item $ $Planinar u novootvorenu formu unosi kratak tekst te opcionalno dokaz kojim bi opravdao svoj zahtjev za dežurnog planinara $ $ ? JE LI POTREBNO?
		...
		\begin{packed_item}
			...
			\item[] \begin{packed_item}
				...
				\item[] \begin{packed_enum}
					\item $ $Planinar ima priliku ponovno poslati zahtjev za dežurnog planinara uz konkretniji dokaz $ $
					\item @TODO Ivan -- pitati Katarinu trebamo li ove dokaze, samo kompliciraju
				\end{packed_enum}
			\end{packed_item}
		\end{packed_item} 
		...
		@TODOIvan pitati -- Katarina je li ovo uopće potrebno?
		...
		\noindent \underbar{\textbf{UC$ $20$ $ -$ $Pregled zahtjeva za posjetom$ $}}
		\begin{packed_item}
		...
		\noindent \underbar{\textbf{UC$ $21$ $ -$ $Prihvatiti/odbiti zahtjev za posjetom planinarskom domu$ $}}
		\begin{packed_item}
			...
			\item[] \begin{packed_enum}
				...
				\item $ $Dežurni planinar pregledava zahtjeve za posjetom prema obrascu \textbf{UC20} $ $
		...
		\end{packed_item} 
			...
			\noindent \underbar{\textbf{UC$ $22$ $ -$ $Dodavanje posjećenih domova u arhivu$ $}}
		\begin{packed_item}
			...
			\item[] \begin{packed_enum}
				...
				\item $ $Dežurni planinar upravlja zahtjevom za posjetom prema obrascu \textbf{UC19}$ $	
			\end{packed_enum}
	
		\end{packed_item}
	
		\noindent \underbar{\textbf{UC$ $23$ $ -$ $Zaslužiti priznanje (bedž)$ $}}
	\begin{packed_item}
	...
	\end{packed_item}	
			...
			\noindent \underbar{\textbf{UC$ $24$ $ -$ $Pregled poruka korisnika$ $}}
		\begin{packed_item}
		...
		\noindent \underbar{\textbf{UC$ $34$ $ -$ $Administrator upravlja planinarskim stazama $ $}}
		\begin{packed_item}
		...
		\noindent \underbar{\textbf{UC$ $35$ $ -$ $Administrator briše korisnički račun $ $}}
		\begin{packed_item}
