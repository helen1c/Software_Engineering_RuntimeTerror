	...
	\end{packed_item}	
		...
		\end{figure}
			...
			\subsection{Sekvencijski dijagrami}
				...
				\textit{. Ukoliko postoji nedoumica oko odabira, razjasniti s asistentom. Uz svaki dijagram napisati detaljni opis dijagrama.}
				\eject
	\begin{figure}[H]
			\includegraphics[scale=0.6]{dijagrami/seq-domovi.png} %veličina slike u odnosu na originalnu datoteku i pozicija slike
			\centering
